...
var controller = {
    ...
    test: function (req, res) {
        return res.status(200).send({
            message: 'Soy el metodo o accion test del controlador de porject'
        });
    },
    saveProject: function (req, res) {

        // Al hacer un new se crea automáticamente un campo _id
    ...
    deleteProject: function (req, res) {
        ...
        Project.findByIdAndRemove(projectId, (err, projectRemoved) => {
            ...
            if (!projectRemoved) return res.status(404).send({ message: 'No se puede eliminar el projecto' });
